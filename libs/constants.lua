...
M.VERSION_IS_DEV = false and M.GAME_VERSION == "dev"
...
M.TARGET_IS_EDITOR = false and M.GAME_TARGET == M.TARGETS.EDITOR
...
M.TARGET_OTHER = true or M.GAME_TARGET == M.TARGETS.OTHER
