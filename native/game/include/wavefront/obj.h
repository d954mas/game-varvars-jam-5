...
public:
    ...
    void closeFace(){
        ...
        if(unusedVerticesCount == 3){
            ...
            std::cout << "ERROR: Face must consists of 3 or 4 vertices.\n";
...
public:
    ...
    void finishLine(){
        int numVertices = vertices.size();
        std::cout << "All    Vertices: " << numVertices << "\n";
        std::cout << "Unused Vertices: " << unusedVerticesCount << "\n";
